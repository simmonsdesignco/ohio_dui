...
<div class="wd_1 aeassessment_page">
  <div class="form-item_custum">
    ...
    <div class="form-item_custum" style='display:none;'>
        <?php print drupal_render($form['field_primary_service_amount']); ?>
    </div>
    <!--
    <div class="form-item_custum">
    ...
    <div class="form-item_custum">
        ...
        <label id="primary_service_amount_one" class="label_item">
            <?php print '$' . $form['#node']->field_rush_order_amount_one['und'][0]['value']; ?>
        </label>
    </div>
    
    <div class="form-item_custum" style='display:none;'>
        <?php print drupal_render($form['field_rush_order_amount_one']); ?>
    </div>
    ...
    <div class="form-item_custum">
        ...
        <label id="primary_service_amount_two" class="label_item">
            <?php print '$' . $form['#node']->field_rush_order_amount_two['und'][0]['value']; ?>
        </label>
    </div>
    
    <div class="form-item_custum" style='display:none;'>
        <?php print drupal_render($form['field_rush_order_amount_two']); ?>
    </div>
    ...
    <div class="form-item_custum">
        ...
        <label id="primary_service_amount_three" class="label_item">
            <?php print '$' . $form['#node']->field_rush_order_amount_three['und'][0]['value']; ?>
        </label>
    </div>
    
    <div class="form-item_custum" style='display:none;'>
        <?php print drupal_render($form['field_rush_order_amount_three']); ?>
    </div>
    ...
    <div class="form-item_custum">
        ...
        <label id="primary_service_amount_four" class="label_item">
            <?php print '$' . $form['#node']->field_rush_order_amount_four['und'][0]['value']; ?>
        </label>
    </div>
    
    <div class="form-item_custum" style='display:none;'>
        <?php print drupal_render($form['field_rush_order_amount_four']); ?>
    </div>
    ...
    <!-- Assessment Description field added END -->
        ...
        <div class="dotted_hr"></div>
        <div class="form-item_custum">
            <?php print drupal_render($form['meta_keywords']); ?>
        </div>
        <div class="form-item_custum">
            <?php print drupal_render($form['meta_description']); ?>
        </div>
